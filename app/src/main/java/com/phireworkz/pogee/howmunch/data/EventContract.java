...
public class EventContract {
    ...
    public static final class ItemEntry implements BaseColumns {
        ...
        public static final String COLUMN_ITEM_DISCOUNT= "discount";
    ...
    public static final class PersonItemEntry implements BaseColumns {
        ...
        public static final String COLUMN_PERSONITEM_AMOUNT = "split_amount";
